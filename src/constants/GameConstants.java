...
public class GameConstants {
    ...
    public static final int JAIL = 180000004, MAX_BUFFSTAT = 10, MAX_MOBSTAT = 10;
...
//                return 20040220;
    ...
    public static boolean isSeparatedSp(int job) {
        return MapleJob.is末日反抗軍(job) || MapleJob.is龍魔導士(job) || MapleJob.is精靈遊俠(job) || MapleJob.is幻影俠盜(job) || MapleJob.is米哈逸(job) || MapleJob.is夜光(job) || MapleJob.is凱撒(job) || MapleJob.is天使破壞者(job) || MapleJob.is曉の陣(job);
//        return !MapleJob.is管理員(job) && !MapleJob.is幻獸師(job) && !MapleJob.is皮卡啾(job);
    ...
    public static void achievementRatio(MapleClient c) {
        ...
        switch (c.getPlayer().getMapId()) {
            ...
            case 923040100:
            case 921160100:
                c.announce(CField.achievementRatio(0));
                break;
            case 930000200:
            case 922010200:
            case 922010300:
            ...
            case 926110001:
            case 921160200:
                c.announce(CField.achievementRatio(10));
                break;
            case 930000300:
            case 910340200:
            case 922010500:
            ...
            case 921160340:
            case 921160350:
                c.announce(CField.achievementRatio(25));
                break;
            case 930000400:
            case 926100200:
            case 926110200:
            ...
            case 926110202:
            case 921160400:
                c.announce(CField.achievementRatio(35));
                break;
            case 910340300:
            case 922010700:
            case 930000500:
            ...
            case 923040300:
            case 921160500:
                c.announce(CField.achievementRatio(50));
                break;
            case 910340400:
            case 922010800:
            case 930000600:
            ...
            case 923040400:
            case 921160600:
                c.announce(CField.achievementRatio(70));
                break;
            case 910340500:
            case 922010900:
            case 930000700:
            ...
            case 921120400:
            case 921160700:
                c.announce(CField.achievementRatio(85));
                break;
            case 922011000:
            case 922011100:
            case 930000800:
            ...
            case 921120500:
            case 921120600:
                c.announce(CField.achievementRatio(100));
                break;
        }
    }
