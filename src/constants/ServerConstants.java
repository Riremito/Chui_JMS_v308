...
public class ServerConstants {
    ...
    public static short MAPLE_VERSION = (short) 308;
    public static String MAPLE_PATCH = "0";
    public static MapleType MAPLE_TYPE = MapleType.日本;

    // Server stuff
    public static boolean USE_LOCALHOST = false;
    public static boolean REDIRECTOR = false; // 退出遊戲返回選角界面開關
    ...
    public static final int MAXIMUM_CONNECTIONS = 1500;
