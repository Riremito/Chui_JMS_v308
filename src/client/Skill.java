...
//        System.out.println("正在解析技能id: " + id);
        ...
        ret.hyperStat = MapleDataTool.getInt("hyperStat", data, 0); // 極限屬性
...
//        System.out.println("解析技能完成id: " + id);
        return ret;
    }
    ...
    public boolean isLinkSkills() {
        switch (this.id) {
            case 80000000: //80000000 - 海盜祝福 - [鏈接技能]學習火砲手特有的強韌，永久性地提高各種屬性。
            case 80000001: //80000001 - 惡魔之怒 - [鏈接技能]對像是BOSS怪時，喚醒內心的憤怒，造成更強的傷害。
            case 80000002: //80000002 - 致命本能 - 擁有通過卓越的洞察力，找到敵人致命弱點的本能。
            case 80000003: //80000003 - 疾風傳授 - 劍豪無所不能！ ！但不知道他有沒有什麼不足的地方呢？
            case 80000004: //80000004 - 紫扇傳授 - 利用五行之力，增加對敵人造成的傷害。
            case 80000005: //80000005 - 穿透 - 用穿透一切阻礙的光之力量，無視敵人的部分防禦力。
            case 80000006: //80000006 - 鋼鐵之牆 - 具有比狂龍戰士更出色的體力。
            case 80000047: //80000047 - 混合邏輯 - 採用混合邏輯設計，所有能力值永久提高。
            case 80000050: //80000050 - 野性狂怒 - 由於憤怒，傷害增加。
            case 80000055: //80000055 - 希納斯護佑 - 覺醒的女皇的護佑充盈體內，使自己避免受到敵人的威脅。
            case 80000066: //80000066 - 希納斯護佑（戰士） - 覺醒的女皇的護佑充盈體內，使自己避免受到敵人的威脅。
            case 80000067: //80000067 - 希納斯護佑（魔法師） - 覺醒的女皇的護佑充盈體內，使自己避免受到敵人的威脅。
            case 80000068: //80000068 - 希納斯護佑（弓箭手） - 覺醒的女皇的護佑充盈體內，使自己避免受到敵人的威脅。
            case 80000069: //80000069 - 希納斯護佑（飛俠） - 覺醒的女皇的護佑充盈體內，使自己避免受到敵人的威脅。
            case 80000070: //80000070 - 希納斯護佑（海盜） - 覺醒的女皇的護佑充盈體內，使自己避免受到敵人的威脅。
            case 80000110: //80000110 - 倫娜的祝福 - [鏈接技能]獲得倫娜女神的祝福，受到的傷害減少。進行攻擊時，無視一部分防禦。 \n#c每次獲得被激活的女神之淚時，技能效果得到強化。
//            case 80000169: //80000169 - 九死一生 - [鏈接技能]受到會導致死亡的攻擊時, 有一定概率不死。
            case 80001040: //80001040 - 精靈的祝福 - [鏈接技能]獲得古代精靈的祝福，可以回到埃歐雷去，經驗值獲得量永久提高。
            case 80001140: //80001140 - 光之守護 - [排名技能]受到光之騎士米哈爾的庇護，在一定時間內，即使受到敵人攻擊也不會被擊退。
            case 80001151: //80001151 - 寶盒的庇佑 - 獲得包含了俠義精神的寶盒的庇佑。從龍的傳人那裡獲得的屬性鏈接，會因為自身和傳授者的等級產生差異。
            case 80001155: //80001155 - 靈魂契約 - 通過與愛絲卡達的契約，瞬間令攻擊力極大化。
            case 80010006: //80010006 - 精靈集中 - 攻擊BOSS怪時,精靈之力會更強。
            case 80000169:
            case 80000188:
            case 80000329:
            case 80000333:
