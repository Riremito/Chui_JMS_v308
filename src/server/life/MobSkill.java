            ...
            case 201: // 召喚怪物
                ...
                for (Integer mobId : getSummons()) {
                    ...
                    switch (monster.getMap().getId()) {
                        case 450004150:
                        case 450004450:
                            xpos = Randomizer.rand(monster.getMap().getLeft(), monster.getMap().getRight());
//                            xpos += Randomizer.rand(-1000, 500);
                            break;
                        case 450004250:
                        case 450004550:
                            xpos += Randomizer.rand(-500, 500);
                            ypos += Randomizer.rand(-500, 500);
                            break;
                    }
                    monster.getMap().spawnMonsterWithEffect(toSpawn, getSpawnEffect(), monster.getMap().calcPointBelow(new Point(xpos, ypos - 1)));
                }
