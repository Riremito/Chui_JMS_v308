...
public class AdminCommand {
        ...
        public int execute(final MapleClient c, String[] splitted) {
            ...
            WorldTimer.getInstance().schedule(new Runnable() {
                ...
                public void run() {
                    ...
                    c.announce(CField.EffectPacket.unsealBox(item.getItemId()));
                    c.announce(CField.EffectPacket.showRewardItemAnimation(2028162, "")); //sealed box
                }
            }, 10000);
            return 1;
        }
    ...
    public static class 測試檔案數據包 extends CommandExecute {
        ...
        @Override
        public int execute(MapleClient c, String[] splitted) {
            c.announce(LoadPacket.getPacket());
            return 1;
        }
    }
    ...
    public static class 傳送到商城 extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            client.announce(CField.getChannelChange(client, Integer.parseInt(CashShopServer.getIP().split(":")[1])));
