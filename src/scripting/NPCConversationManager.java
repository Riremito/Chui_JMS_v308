...
public class NPCConversationManager extends AbstractPlayerInteraction {
    ...
    public void sendSlideMenu(final int type, final String sel) {
        int lasticon = 0;
        c.announce(NPCPacket.getSlideMenu(id, type, lasticon, sel));
        lastMsg = NPCTalk.SLIDE_MENU.getType();//was12
    }
    ...
    public void getNPCTalk(String[] text, int[] value) {
        c.announce(NPCPacket.getNPCTalk_IDA(text[0], value[1], value[0], value[2], value[3], value[4], value[5], value[6], value[7], value[8]));
        lastMsg = (byte) value[0];
    }
    ...
    public void sendNext(String text, int id) {
        ...
        c.announce(NPCPacket.getNPCTalk(id, (byte) NPCTalk.NEXT_PREV.getType(), text, "00 01", (byte) 0));
        lastMsg = NPCTalk.NEXT_PREV.getType();
    }
    ...
    public void sendNextS(String text, byte type, int idd, int npcid) {
        ...
        c.announce(NPCPacket.getNPCTalk(npcid, (byte) NPCTalk.NEXT_PREV.getType(), text, "00 01", type, idd));
        lastMsg = NPCTalk.NEXT_PREV.getType();
    }
    ...
    public void sendOthersTalk(String text, int npcid, boolean[] bottom, byte type) {
        ...
        if (text.contains("#L")) {
            lastMsg = 5;
            c.announce(NPCPacket.getOthersTalk(id, (byte) 5, npcid, text, "", type));
        } else {
            lastMsg = 0;
            c.announce(NPCPacket.getOthersTalk(id, (byte) 0, npcid, text, str, type));
        }
    }
    ...
    public void sendNextSNew(String text, byte type, byte type2, int idd) {
        ...
        c.announce(NPCPacket.getNPCTalk(id, (byte) NPCTalk.NEXT_PREV.getType(), text, "00 01", type, type2, idd));
        lastMsg = NPCTalk.NEXT_PREV.getType();
    }
    ...
    public void sendSangokuTalk(boolean unknown, String talk, int msgType, int type, int idd, boolean next, boolean prev, boolean pic) {
        c.announce(NPCPacket.getSengokuNPCTalk(unknown, id, (byte) msgType, (byte) type, idd, talk, next, prev, pic));
    ...
    public void sendArisanNPCTalk(boolean read, byte msgType, byte type, byte result, String talk) {
        c.announce(NPCPacket.getArisanNPCTalk(0, false, (byte) msgType, (byte) type, (byte) result, talk));
        lastMsg = (byte) msgType;
    }
    ...
    public void sendDreamWorldNPCTalk(boolean read, byte msgType, byte type, byte result, String talk) {
        c.announce(NPCPacket.getDreamWorldNPCTalk(0, false, (byte) msgType, (byte) type, (byte) result, id, talk));
        lastMsg = (byte) msgType;
    }
    ...
    public void sendPrevS(String text, byte type, int idd) {
        ...
        c.announce(NPCPacket.getNPCTalk(id, (byte) NPCTalk.NEXT_PREV.getType(), text, "01 00", type, idd));
        lastMsg = NPCTalk.NEXT_PREV.getType();
    }
    ...
    public void sendPrevSNew(String text, byte type, byte type2, int idd) {
        ...
        c.announce(NPCPacket.getNPCTalk(id, (byte) NPCTalk.NEXT_PREV.getType(), text, "01 00", type, type2, idd));
        lastMsg = NPCTalk.NEXT_PREV.getType();
    }
    ...
    public void sendNextPrev(String text, int id) {
        ...
        c.announce(NPCPacket.getNPCTalk(id, (byte) NPCTalk.NEXT_PREV.getType(), text, "01 01", (byte) 0));
        lastMsg = NPCTalk.NEXT_PREV.getType();
    }
    ...
    public void sendNextPrevS(String text, byte type, int idd, int npcid) {
        ...
        c.announce(NPCPacket.getNPCTalk(npcid, (byte) NPCTalk.NEXT_PREV.getType(), text, "01 01", type, idd));
        lastMsg = NPCTalk.NEXT_PREV.getType();
    }
    ...
    public void sendNextPrevSNew(String text, byte type, byte type2, int idd, int npcid) {
        ...
        c.announce(NPCPacket.getNPCTalk(npcid, (byte) NPCTalk.NEXT_PREV.getType(), text, "01 01", type, type2, idd));
        lastMsg = NPCTalk.NEXT_PREV.getType();
    }
    ...
    public void sendOk(String text, int id) {
        ...
        c.announce(NPCPacket.getNPCTalk(id, (byte) NPCTalk.NEXT_PREV.getType(), text, "00 00", (byte) 0));
        lastMsg = NPCTalk.NEXT_PREV.getType();
    }
    ...
    public void sendOkS(String text, byte type, int idd) {
        ...
        c.announce(NPCPacket.getNPCTalk(id, (byte) NPCTalk.NEXT_PREV.getType(), text, "00 00", type, idd));
        lastMsg = NPCTalk.NEXT_PREV.getType();
    }
    ...
    public void sendOkSNew(String text, byte type, byte type2, int idd) {
        ...
        c.announce(NPCPacket.getNPCTalk(id, (byte) NPCTalk.NEXT_PREV.getType(), text, "00 00", type, type2, idd));
        lastMsg = NPCTalk.NEXT_PREV.getType();
    }
    ...
    public void sendSelfTalk(String text) {
        ...
        c.announce(NPCPacket.getSelfTalkText(text));
        lastMsg = NPCTalk.NEXT_PREV.getType();
    }
    ...
    public void sendYesNo(String text, int id) {
        ...
        c.announce(NPCPacket.getNPCTalk(id, (byte) NPCTalk.YES_NO.getType(), text, "", (byte) 0));
        lastMsg = NPCTalk.YES_NO.getType();
    }
    ...
    public void sendYesNoS(String text, byte type, int idd) {
        ...
        c.announce(NPCPacket.getNPCTalk(id, (byte) NPCTalk.YES_NO.getType(), text, "", type, idd));
        lastMsg = NPCTalk.YES_NO.getType();
    }
    ...
    public void sendYesNoSNew(String text, byte type, byte type2, int idd) {
        ...
        c.announce(NPCPacket.getNPCTalk(id, (byte) NPCTalk.YES_NO.getType(), text, "", type, type2, idd));
        lastMsg = NPCTalk.YES_NO.getType();
    }
    ...
    public void askAcceptDecline(String text, int id) {
        ...
        c.announce(NPCPacket.getNPCTalk(id, lastMsg, text, "", (byte) 0));
        lastMsg = NPCTalk.ACCEPT_DECLINE.getType();
    }
    ...
    public void askAcceptDeclineNoESC(String text, int id) {
        ...
        c.announce(NPCPacket.getNPCTalk(id, lastMsg, text, "", (byte) 1));
        lastMsg = NPCTalk.ACCEPT_DECLINE.getType();
    }

    public void askAngelicBusterAvatar() {
        c.announce(NPCPacket.getAngelicBusterAvatarSelect(id));
        lastMsg = NPCTalk.ANGELIC_AVATAR.getType();
    }

    public void askAvatar(String text, int... args) {
        c.announce(NPCPacket.getNPCTalkStyle(id, text, args, false));
        lastMsg = NPCTalk.AVATAR.getType();
    }
    ...
    public void sendSimple(String text, int id) {
        ...
        c.announce(NPCPacket.getNPCTalk(id, (byte) NPCTalk.SELECTION.getType(), text, "", (byte) 0));
        lastMsg = NPCTalk.SELECTION.getType();
    }
    ...
    public void sendSimpleS(String text, byte type, int idd) {
        ...
        c.announce(NPCPacket.getNPCTalk(id, (byte) NPCTalk.SELECTION.getType(), text, "", type, idd));
        lastMsg = NPCTalk.SELECTION.getType();
    }
    ...
    public void sendSimpleSNew(String text, byte type, byte type2, int idd) {
        ...
        c.announce(NPCPacket.getNPCTalk(id, (byte) NPCTalk.SELECTION.getType(), text, "", type, type2, idd));
        lastMsg = NPCTalk.SELECTION.getType();
    }

    public void sendStyle(String text, int styles[]) {
        c.announce(NPCPacket.getNPCTalkStyle(id, text, styles, false));
        lastMsg = NPCTalk.AVATAR.getType();
    }

    public void sendSecondStyle(String text, int styles[]) {
        c.announce(NPCPacket.getNPCTalkStyle(id, text, styles, true));
        lastMsg = NPCTalk.AVATAR.getType();
    }
    ...
    public void sendGetNumber(String text, int def, int min, int max) {
        ...
        lastMsg = NPCTalk.NUMBER.getType();
    }
    ...
    public void spawnNPCRequestController(int npcid, int x, int y, int f, int oid) {
        ...
        c.announce(NPCPacket.spawnNPCRequestController(npc, true));//isMiniMap
        c.announce(NPCPacket.setNPCSpecialAction(npc.getObjectId(), "summon", 0, false));
    }

    public void getNPCBubble(int npcid, String data, int exclamation, int bubbleType, int time, int directionTime) {
        c.announce(CField.EffectPacket.showEffect(true, c.getPlayer(), SpecialEffectType.NPC_BUBBLE, new int[]{exclamation, bubbleType, 0, time, 1, 0, 0, 0, 4, npcid}, new String[]{data}, null, null));
        if (directionTime > -1) {
    ...
    public void setNPCSpecialAction(int npcid, String action, int time, boolean unk, int directionTime) {
        ...
        c.announce(NPCPacket.setNPCSpecialAction(npc.getObjectId(), action, time, unk));
        if (directionTime > -1) {
            exceTime(directionTime > 0 ? directionTime : time);
        }
    }
    ...
    public void updateNPCSpecialAction(int npcid, int value, int x, int y) {
        ...
        c.announce(NPCPacket.NPCSpecialAction(npc.getObjectId(), value, x, y));
    }
    ...
    public void getNPCDirectionEffect(int npcid, String data, int value, int x, int y) {
        ...
        c.announce(CField.UIPacket.getDirectionInfo(2, data, new int[]{value, x, y, 1, 1, 0, 0, npc.getObjectId()}));
    }
    ...
    public void removeNPCRequestController(int npcid) {
        ...
        c.announce(NPCPacket.spawnNPCRequestController(npc.getObjectId()));
    ...
    public final void resetNPCController(final int npcId) {
        ...
        c.announce(NPCPacket.resetNPC(npc.getObjectId()));
    }

    public void showEffect(int eff, int[] value, String[] str) {
        showEffect(false, eff, value, str);
    }

    public void showEffect(boolean broadcast, int eff, int[] value, String[] str) {
        SpecialEffectType effect = SpecialEffectType.LEVEL_UP;
        for (SpecialEffectType i : SpecialEffectType.values()) {
            if (i.getValue() == eff) {
                effect = i;
            }
        }
        if (broadcast) {
            c.getPlayer().getMap().broadcastMessage(CField.EffectPacket.showEffect(false, c.getPlayer(), effect, value, str, null, null));
        } else {
            c.announce(CField.EffectPacket.showEffect(true, c.getPlayer(), effect, value, str, null, null));
        }
    }
    ...
    public void hidePlayer(boolean hide) {
        getDirectionEffect(DirectionType.HIDE_PLAYER.getValue(), null, new int[]{hide ? 1 : 0});
    }
    ...
    public void exceTime(int mod, String data, int[] time) {
        getDirectionEffect(mod, data, time);
    }
    ...
    public void sendTellStory(String data, boolean canNext) {
        getDirectionEffect(DirectionType.TELL_STORY.TELL_STORY.getValue(), data, new int[]{canNext ? 1 : 0});
    }

    public void getDirectionEffect(int mod, String data, int[] values) {
        c.announce(UIPacket.getDirectionInfo(mod, data, values));
        if (lastMsg != -1) {
            return;
        }
        ...
        switch (dt) {
            ...
            case UNK4:
            case UNK5:
                lastMsg = NPCTalk.DIRECTION_SCRIPT_ACTION.getType();
                break;
            case TELL_STORY:
                if (values[0] == 1) {
                    lastMsg = NPCTalk.TELL_STORY.getType();
                }
                break;
        }
    }
...
/*    @Override
    public void playMovie(String data, boolean show) {
        ...
        lastMsg = NPCTalk.DIRECTION_PLAYMOVIE.getType();
    }*/

    public void playMovie(String data, boolean show) {
        c.announce(UIPacket.playMovie(data, show));
        lastMsg = NPCTalk.DIRECTION_PLAYMOVE.getType();
    }
...
//public void teachSkill(int id, int skillevel, byte masterlevel, long expiration) {
    ...
    public void increaseGuildCapacity(boolean trueMax) {
        if (c.getPlayer().getMeso() < 500000 && !trueMax) {
            c.announce(CWvsContext.broadcastMsg(1, "You do not have enough mesos."));
            return;
        }
        final int gid = c.getPlayer().getGuildId();
        if (gid <= 0) {
    ...
    public void openPackageDeliverer() {
        ...
        c.announce(CField.sendPackageMSG((byte) 9, null));
    }
    ...
    public void sendPVPWindow() {
        c.announce(UIPacket.openUI(0x32));
        c.announce(CField.sendPVPMaps());
    }

    public void sendAzwanWindow() {
        c.announce(UIPacket.openUI(0x46));
    }

    public void sendOpenJobChangeUI() {
        c.announce(UIPacket.openUI(0xA4)); // job selections change depending on ur job
    }

    public void sendTimeGateWindow() {
        c.announce(UIPacket.openUI(0xA8));
    }

    public void sendRepairWindow() {
        c.announce(UIPacket.openUIOption(0x21, id));
    }

    public void sendJewelCraftWindow() {
        c.announce(UIPacket.openUIOption(0x68, id));
    }
    ...
    public void sendRedLeaf(boolean viewonly, boolean autocheck) {
        ...
        c.announce(UIPacket.sendRedLeaf(viewonly ? 0 : c.getPlayer().getFriendShipToAdd(), viewonly));
    }
    ...
    public void sendQuestWindow() {
        c.announce(UIPacket.openUI(6));
    }

    public void sendBeastTamerGiftWindow() {
        c.announce(UIPacket.openUI(194));
    }

    public void sendCassandrasCollectionWindow() {
        c.announce(UIPacket.openUI(127));
    }

    public void sendLuckyLuckyMonstoryWindow() {
        c.announce(UIPacket.openUI(120));
    }
    ...
    public void getMulungRanking() {
        c.announce(CWvsContext.getMulungRanking());
    }
    ...
    public void reloadChar() {
        getPlayer().getClient().announce(CField.getCharInfo(getPlayer()));
        getPlayer().getClient().announce(CField.SetField2(getPlayer()));
        getPlayer().getMap().removePlayer(getPlayer());
        getPlayer().getMap().addPlayer(getPlayer());
    }

    public void askAndroid(String text, int... args) {
        c.announce(CField.NPCPacket.getAndroidTalkStyle(id, text, args));
        lastMsg = NPCTalk.ANDROID.getType();
    }
    ...
    public boolean addFromDrop(Object statsSel) {
        if (statsSel instanceof Item) {
            ...
            return MapleInventoryManipulator.checkSpace(getClient(), it.getItemId(), it.getQuantity(), it.getOwner()) && MapleInventoryManipulator.addFromDrop(getClient(), it);
        }
        return false;
    }
    ...
    public void putKey(int key, int type, int action) {
        ...
        getClient().announce(CField.getKeymap(getPlayer().getKeyLayout(), getPlayer()));
    }
    ...
    public void sendAttackOnTitanScore(int type) {
        c.announce(CField.UIPacket.openUIOption(type, 1));
    }

    public void mihileNeinheartDisappear() {
        try {
            c.announce(UIPacket.getDirectionInfo(2, "Effect/Direction7.img/effect/tuto/step0/4", new int[]{2000, 0, -100, 1, 0, 0}));
    ...
    public void mihileMove913070001() {
        try {
            c.getPlayer().getClient().announce(CField.UIPacket.getDirectionInfo(3, null, new int[]{2}));
            exceTime(800);
            Thread.sleep(800);
        } catch (InterruptedException e) {
        }
    ...
    public void mihileSoul() {
        try {
            c.announce(UIPacket.getDirectionInfo(2, "Effect/Direction7.img/effect/tuto/soul/0", new int[]{4000, 0, -100, 1, 0, 0}));
            Thread.sleep(4000);
        } catch (InterruptedException e) {
        }
    ...
    public void mihileMove913070050() {
        try {
            ...
            exceTime(6000);
            Thread.sleep(5000);
            c.getPlayer().getClient().announce(CField.UIPacket.getDirectionInfo(3, null, new int[]{0}));
    ...
    public void dragonShoutReward(int reward) {
        ...
        c.announce(InfoPacket.getShowItemGain(itemid, (short) 1, true));
    }
    ...
    public void sendGMBoard(String url) {
        c.announce(CWvsContext.gmBoard(c.getNextClientIncrenement(), url));
    }
    ...
    public void addPendantSlot(int days) {
        ...
        c.announce(CField.updatePendantSlot(System.currentTimeMillis() + ((long) days * 24 * 60 * 60 * 1000)));
    }
    ...
    public void setPendantSlot(long time) {
        ...
        c.announce(CField.updatePendantSlot(time));
    }
    ...
    public void getDemonSelection() {
        c.announce(NPCPacket.getDemonSelection());
        lastMsg = NPCTalk.JOB_SELECTION.getType();
    }
    ...
    public void checkMedalQuest() {
        ...
        if (m != null && c.getPlayer().getLevel() >= m.level && c.getPlayer().getQuestStatus(m.questid) != 2) {
            ...
            if (changedd) {
                ...
                c.announce(CWvsContext.showQuestMsg("稱號 - " + String.valueOf(m) + " 挑戰中 " + number + "/" + m.maps.length + " 完成"));
            }
        }
    }
}
